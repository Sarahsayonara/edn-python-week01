...
#Entrada:o número de um funcionário, seu número de horas trabalhadas e o valor que recebe por hora. 
...
# Deve haver um espaço em branco antes e depois do sinal de igualdade, e no caso do salário, também um espaço em branco após o R$
